...
const POS = () => (
  <div className="flex items-center justify-center h-screen w-screen bg-gray-100 text-2xl font-bold">
    POS Billing Screen (Full Screen)
  </div>
);
const KOTScreen = () => (
  <div className="flex items-center justify-center h-screen w-screen bg-slate-900 text-white text-2xl font-bold">
